            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <input type="hidden"  name="username" value="<?php echo $user;?>" required="required" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="topik" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="file" value="<?php echo date('d-M-Y');?>" class="form-control col-md-7 col-xs-12" disabled="">
                      </div>
                    </div>
