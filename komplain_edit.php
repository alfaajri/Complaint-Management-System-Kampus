            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" action="komplain_edit_proses.php" method="POST" enctype="multipart/form-data">
             ...
             <input type="hidden"  name="id" value="<?php echo $komplainRow['id'];?>" required="required" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="jenis_komplain" class="form-control col-md-7 col-xs-12" required="required">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="topik" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $komplainRow['topik'];?>">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="textarea" required="required" name="deskripsi" class="form-control col-md-7 col-xs-12"><?php echo $komplainRow['deskripsi'];?></textarea>
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="file"  name="file" class="form-control col-md-7 col-xs-12" value="<?php echo $komplainRow['file_pendukung'];?>">
                      </div>
                    </div>
                    <div class="item form-group">
